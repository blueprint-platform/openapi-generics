...
class WrapperSchemaProcessorTest {
    ...
    @Test
    @DisplayName("process -> should enrich wrapper and delegate container enrichment for default envelope")
    ...
    @Test
    @DisplayName("process -> should delegate container enrichment for default envelope container response")
