...
import io.github.blueprintplatform.samples.customerservice.client.generated.dto.*;
...
class CustomerClientAdapterImplTest {
  ...
  @Test
  @DisplayName("createCustomer -> delegates to API and returns ServiceResponse<CustomerDto>")
  void createCustomer_delegates_and_returns_data_meta() {
    ...
    var dto = new CustomerDto(1, "Jane Doe", "jane@example.com");
  ...
  @Test
  @DisplayName("getCustomer -> returns a single CustomerDto")
  void getCustomer_delegates_and_returnsDto() {

    var dto = new CustomerDto(42, "John Smith", "john.smith@example.com");
  ...
  @Test
  @DisplayName("getCustomers -> returns Page<CustomerDto>")
  void getCustomers_delegates_and_returnsPage() {

    var d1 = new CustomerDto(1, "A", "a@example.com");
    var d2 = new CustomerDto(2, "B", "b@example.com");
  ...
  @Test
  @DisplayName("updateCustomer -> returns updated CustomerDto")
  void updateCustomer_delegates_and_returnsUpdated() {
    ...
    var dto = new CustomerDto(1, "Jane Updated", "jane.updated@example.com");
