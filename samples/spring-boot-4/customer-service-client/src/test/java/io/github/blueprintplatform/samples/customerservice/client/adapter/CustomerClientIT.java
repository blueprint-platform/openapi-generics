...
class CustomerClientIT {
  ...
  @Test
  @DisplayName("POST /customers -> 201 Created + maps {data, meta}")
  ...
  @Test
  @DisplayName("GET /customers/{id} -> 200 OK + maps {data, meta}")
  ...
  @Test
  @DisplayName("GET /customers -> 200 OK + maps Page<CustomerDto> in data and meta")
  ...
  @Test
  @DisplayName("PUT /customers/{id} -> 200 OK + maps {data, meta}")
