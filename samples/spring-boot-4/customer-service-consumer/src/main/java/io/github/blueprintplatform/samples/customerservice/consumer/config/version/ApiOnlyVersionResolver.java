package io.github.blueprintplatform.samples.customerservice.consumer.config.version;
...
public class ApiOnlyVersionResolver implements ApiVersionResolver {
  ...
  public ApiOnlyVersionResolver(String headerName, String contextPath, String apiBasePath) {
